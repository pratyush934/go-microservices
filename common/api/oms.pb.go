...
const file_api_oms_proto_rawDesc = "" +
	...
	"customerId\x12,\n" +
	"\x05Items\x18\x02 \x03(\v2\x16.api.ItemsWithQuantityR\x05Items\"\x15\n" +
	"\x13CreateOrderResponse2B\n" +
	"\fOrderService\x122\n" +
	"\vCreateOrder\x12\x17.api.CreateOrderRequest\x1a\n" +
	".api.OrderB7Z5github.com/pratyush934/mastering-gobackend/common/apib\x06proto3"
